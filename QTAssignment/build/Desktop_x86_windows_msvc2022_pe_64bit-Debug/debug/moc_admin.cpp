...
Q_CONSTINIT const QMetaObject Admin::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAdminENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'getInstance'
        QtPrivate::TypeAndForceComplete<Admin *, std::false_type>,
        // method 'openAddStudentDialog'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'openAddTeacherDialog'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'addSubject'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->studentAdded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->teacherAdded((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: { Admin* _r = _t->getInstance();
            if (_a[0]) *reinterpret_cast< Admin**>(_a[0]) = std::move(_r); }  break;
        case 3: _t->openAddStudentDialog(); break;
        case 4: _t->openAddTeacherDialog(); break;
        case 5: _t->addSubject(); break;
        case 6: _t->returnToLogin(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Admin::*)(const QString & );
            if (_t _q_method = &Admin::studentAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Admin::*)(const QString & );
            if (_t _q_method = &Admin::teacherAdded; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Admin::studentAdded(const QString & _t1)
{
...
// SIGNAL 1
void Admin::teacherAdded(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
